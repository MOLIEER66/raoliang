 ...
 * @license MIT
 * @updateUrl http://SERVER_ADDRESS_REDACTED/api/releases?script=HYWmusic_%E5%85%AC%E7%9B%8A%E7%89%88&scriptType=free&releaseType=lx&version=v1.0.0
 *
 * 支持平台: kw、kg、tx、wy、mg
...
// ====== 运行参数 ======
const API_BASE = 'http://SERVER_ADDRESS_REDACTED'
const CARD_KEY = 'CARD_KEY_REDACTED'  // 已脱敏，真实值见仓库外 fixtures
...
const UPDATE_URL = 'http://SERVER_ADDRESS_REDACTED/api/releases?script=HYWmusic_%E5%85%AC%E7%9B%8A%E7%89%88&scriptType=free&releaseType=lx&version=v1.0.0'
